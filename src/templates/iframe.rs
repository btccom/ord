  ...
  fn fmt(&self, f: &mut Formatter) -> fmt::Result {
    if self.thumbnail {
      write!(
        f,
        "<a href=/inscription/{}>\
          <iframe id=iframe1 sandbox=allow-scripts scrolling=no loading=lazy src=/preview/{} style=border-radius:0.3rem;overflow:hidden;transform:translateZ(10px);>\
          </iframe>\
        </a>",
      ...
      write!(
        f,
        "<iframe id=iframe1 sandbox=allow-scripts loading=lazy src=/preview/{} style=border-radius:0.3rem;overflow:hidden;transform:translateZ(10px);></iframe>",
        self.inscription_id,
      )
    }
  }
